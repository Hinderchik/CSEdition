...
/**
 * Режим игры. Определяет правила раунда и стартовое оружие.
 *
 * Встроенные режимы:
 *   - CLASSIC: стандартный CS — пистолет + нож, покупка в BUY_TIME
 *   - DEATHMATCH: респавн, всё оружие бесплатно, без покупки
 *   - GUNGAME: каждое убийство = новое оружие, нож = победа
 *   - PISTOL_ONLY: только пистолеты
...
public class GameMode {
    ...
    /**
     * Создаёт встроенный режим CLASSIC.
     */
    ...
    /**
     * Создаёт встроенный режим DEATHMATCH.
     */
    ...
    /**
     * Создаёт встроенный режим GUNGAME.
     */
    ...
    /**
     * Создаёт встроенный режим PISTOL_ONLY.
     */
